				...
				<form class="d-flex" role="search">
					...
					%>
						...
						<div class="row text-center" style="margin-left: 0.25em">
							...
							<b> <span> <%=khachHang.getHoVaTen()%></span></b>
						</div>
						<ul class="navbar-nav me-auto mb-2 mb-lg-0 bg-infor ">
							<li class="nav-item dropdown dropstart"><a
								...
								<ul class="dropdown-menu">
									...
									<li><a class="dropdown-item" href="<%= url %>/khachhang/thaydoithongtin.jsp">Thay đổi thông
											tin</a></li>
									<li><a class="dropdown-item" href="<%= url %>/khachhang/doimatkhau.jsp">Đổi
											mật khẩu</a></li>
									<li><hr class="dropdown-divider"></li>
									<li><a class="dropdown-item" href="<%= url %>/khachhang?hanhDong=dangxuat">Thoát tài
											khoản</a></li>
								</ul></li>
						</ul>
